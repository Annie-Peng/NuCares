...
interface LifeSurveyFormSecondPhaseProps {
  setCurrentPhase: (currentPhase: number) => void;
}

const LifeSurveyFormSecondPhase: FC<LifeSurveyFormSecondPhaseProps> = ({
  setCurrentPhase,
}) => {
  const showQRange = [4, 8];
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="mt-16 h-[45px] relative">
        <Image src={lifeSurveyStep2} layout="fill" alt="lifeSurveyStep2" />
      </div>
...
export default LifeSurveyFormSecondPhase;
