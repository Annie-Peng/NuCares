  ...
  return (
    <footer className="bg-white">
      <div className="container grid cusGridPC grid-flow-row items-center text-primary-500 py-40 text-center justify-center gap-y-16 lg:gap-y-0 lg:text-left lg:py-50 lg:justify-between">
        ...
        <ul className="link flex font-normal text-14 flex-col gap-y-20 order-2 border-t border-primary-500 pt-[26px] hidden lg:pt-0 lg:ps-20 lg:ms-8 lg:col-span-2 lg:gap-y-16 lg:col-start-7 lg:border-l-2 lg:border-t-0 lg:order-3 lg:block">
          <li>
